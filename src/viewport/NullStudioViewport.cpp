...
namespace CNA::Studio
{
    ...
    UiTextureId NullStudioViewport::render(const SceneDocument& scene,
                                           int width,
                                           int height,
    ...
    UiTextureId NullStudioViewport::renderWireframe(const std::vector<WireSegment>& segments, int width,
                                                    int height)
    {
