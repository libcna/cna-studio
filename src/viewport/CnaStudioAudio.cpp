...
namespace CNA::Studio
{
    ...
    class CnaStudioAudio final : public StudioAudio
    {
    public:
        explicit CnaStudioAudio(const AssetDatabase& assets) : assets_(&assets) {}
    ...
    std::unique_ptr<StudioAudio> createCnaStudioAudio(const AssetDatabase& assets)
    {
        return std::make_unique<CnaStudioAudio>(assets);
    }
}
