...
namespace CNA::Studio
{
    ...
    void NullStudioUi::endFrame()
    {
        lastFramePanels_ = currentFramePanels_;
    }

    bool NullStudioUi::beginPanel(const std::string& title, DockSide preferredSide)
    {
        (void)preferredSide;
    ...
    bool NullStudioUi::propertyField(const std::string& label,
                                     PropertyValue& value,
    ...
    UiTreeNodeResult NullStudioUi::treeNode(const Uuid& id,
    ...
    bool NullStudioUi::menuItem(const std::string& label, const std::string& shortcut, bool enabled)
    {
        (void)label;
        (void)shortcut;
        (void)enabled;
    ...
    void NullStudioUi::pressShortcut(UiKey key, UiKeyModifiers modifiers)
    {
        shortcuts_.push_back(PendingShortcut{key, modifiers});
    }

    bool NullStudioUi::isShortcutPressed(UiKey key, UiKeyModifiers modifiers)
    {
