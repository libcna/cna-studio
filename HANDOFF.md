...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **278 of 573 tasks are complete.**
...
**Phase 30 — Large-project performance** (6 of 16).

**Phase 30 — Large-project performance** (6 of 16). Neither was planned for this session and both
