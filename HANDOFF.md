...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **291 of 575 tasks are complete.**
...
**Phase 30 — Large-project performance** (10 of 16).

**Phase 30 — Large-project performance** (10 of 16). Neither was planned for this session and both
