...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **230 of 563 tasks are complete.**
...
**Phase 7 — Panel migration** (31 of 46, 2 in progress). The strangler seam itself — one log model
