...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **294 of 576 tasks are complete.**
...
**Phase 30 — Large-project performance** (13 of 17).

**Phase 30 — Large-project performance** (13 of 17). Neither was planned for this session and both
