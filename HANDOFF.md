...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **223 of 548 tasks are complete.**
...
**Phase 7 — Panel migration** (26 of 34, 2 in progress). The strangler seam itself — one log model
