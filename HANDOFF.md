...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **226 of 550 tasks are complete.**
...
**Phase 7 — Panel migration** (27 of 34, 2 in progress). The strangler seam itself — one log model
