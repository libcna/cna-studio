...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **236 of 564 tasks are complete.**
...
**Phase 7 — Panel migration** (37 of 46, 2 in progress). The strangler seam itself — one log model
