...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **275 of 573 tasks are complete.**
...
**Phase 30 — Large-project performance** (3 of 16).

**Phase 30 — Large-project performance** (3 of 16). Neither was planned for this session and both
