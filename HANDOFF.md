...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **228 of 551 tasks are complete.**
...
**Phase 7 — Panel migration** (29 of 34, 2 in progress). The strangler seam itself — one log model
