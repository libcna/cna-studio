...
Task ids are `STUDIO-PPNNN`; see `plan.md` for the full list. **222 of 548 tasks are complete.**
...
**Phase 2 — Architecture refresh** (32 of 38). The architecture record, the CNA gap register, the
...
**Phase 7 — Panel migration** (25 of 34, 2 in progress). The strangler seam itself — one log model
