...
/**
 * @file CNA/Studio/Core/PropertyValue.hpp
...
namespace CNA::Studio
{
    ...
    public:
        ...
        PropertyValue(StudioColor value) : storage_(value) {}
        PropertyValue(StudioVector2 value) : storage_(value) {}
        PropertyValue(StudioVector3 value) : storage_(value) {}
        PropertyValue(StudioVector4 value) : storage_(value) {}
        PropertyValue(StudioQuaternion value) : storage_(value) {}
        PropertyValue(StudioRectangle value) : storage_(value) {}
