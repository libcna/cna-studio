...
/**
 * @file CNA/Studio/Core/ComponentDescriptor.hpp
 ...
 *
 * A descriptor is *data*, not a C++ type: StudioComponent stores its properties in a name-keyed
...
namespace CNA::Studio
{
    ...
    struct PropertyDescriptor
    {
         ...
         * in `cna-studio-core`, below the asset database that owns that enumeration -- and so a
