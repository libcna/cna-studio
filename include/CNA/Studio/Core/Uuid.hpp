...
namespace std
{
    /** @brief Enables CNA::Studio::Uuid as a key in unordered containers. */
    template <>
    struct hash<CNA::Studio::Uuid>
    {
        std::size_t operator()(const CNA::Studio::Uuid& value) const noexcept;
    };
}
