...
/**
 * @file CNA/Studio/Core/StudioMath.hpp
 ...
 * cna-studio-core must link nothing from CNA, so that the document model, the undo stack and the
 ...
 * cna-studio-viewport -- where the dependency is unavoidable anyway.
 *
...
namespace CNA::Studio
{
    ...
    struct StudioVector2
    {
        float x = 0.0f;
        float y = 0.0f;

        friend bool operator==(const StudioVector2& lhs, const StudioVector2& rhs)
        {
            return lhs.x == rhs.x && lhs.y == rhs.y;
        }
        friend bool operator!=(const StudioVector2& lhs, const StudioVector2& rhs) { return !(lhs == rhs); }
    };

    /** @brief Three-component float vector. Mirrors Microsoft::Xna::Framework::Vector3. */
    struct StudioVector3
    {
        float x = 0.0f;
        float y = 0.0f;
        float z = 0.0f;

        friend bool operator==(const StudioVector3& lhs, const StudioVector3& rhs)
        {
            return lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z;
        }
        friend bool operator!=(const StudioVector3& lhs, const StudioVector3& rhs) { return !(lhs == rhs); }
    };

    /** @brief Four-component float vector. Mirrors Microsoft::Xna::Framework::Vector4. */
    struct StudioVector4
    {
        float x = 0.0f;
        float y = 0.0f;
        float z = 0.0f;
        ...
        friend bool operator==(const StudioVector4& lhs, const StudioVector4& rhs)
        {
            return lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z && lhs.w == rhs.w;
        }
        friend bool operator!=(const StudioVector4& lhs, const StudioVector4& rhs) { return !(lhs == rhs); }
    };
    ...
    struct StudioQuaternion
    {
        ...
        friend bool operator==(const StudioQuaternion& lhs, const StudioQuaternion& rhs)
        {
            return lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z && lhs.w == rhs.w;
        }
        friend bool operator!=(const StudioQuaternion& lhs, const StudioQuaternion& rhs) { return !(lhs == rhs); }
    };
    ...
    struct StudioColor
    {
        ...
        friend bool operator==(const StudioColor& lhs, const StudioColor& rhs)
        {
            return lhs.r == rhs.r && lhs.g == rhs.g && lhs.b == rhs.b && lhs.a == rhs.a;
        }
        friend bool operator!=(const StudioColor& lhs, const StudioColor& rhs) { return !(lhs == rhs); }
    };

    /** @brief Integer rectangle in texel space. Mirrors Microsoft::Xna::Framework::Rectangle. */
    struct StudioRectangle
    {
        int x = 0;
        int y = 0;
        int width = 0;
        ...
        friend bool operator==(const StudioRectangle& lhs, const StudioRectangle& rhs)
        {
            return lhs.x == rhs.x && lhs.y == rhs.y && lhs.width == rhs.width && lhs.height == rhs.height;
        }
        friend bool operator!=(const StudioRectangle& lhs, const StudioRectangle& rhs) { return !(lhs == rhs); }
    };

    /** @brief Returns @p a + @p b. */
    [[nodiscard]] inline StudioVector3 add(const StudioVector3& a, const StudioVector3& b)
    {
        return StudioVector3{a.x + b.x, a.y + b.y, a.z + b.z};
    }

    /** @brief Returns @p a - @p b. */
    [[nodiscard]] inline StudioVector3 subtract(const StudioVector3& a, const StudioVector3& b)
    {
        return StudioVector3{a.x - b.x, a.y - b.y, a.z - b.z};
    }

    /** @brief Returns @p vector scaled by @p factor. */
    [[nodiscard]] inline StudioVector3 scale(const StudioVector3& vector, float factor)
    {
        return StudioVector3{vector.x * factor, vector.y * factor, vector.z * factor};
    }

    /** @brief Returns the dot product of @p a and @p b. */
    [[nodiscard]] inline float dot(const StudioVector3& a, const StudioVector3& b)
    {
        return a.x * b.x + a.y * b.y + a.z * b.z;
    }

    /** @brief Returns the right-handed cross product @p a x @p b. */
    [[nodiscard]] inline StudioVector3 cross(const StudioVector3& a, const StudioVector3& b)
    {
        return StudioVector3{a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x};
    }

    /** @brief Returns the length of @p vector. */
    [[nodiscard]] inline float length(const StudioVector3& vector) { return std::sqrt(dot(vector, vector)); }
     ...
     */
    [[nodiscard]] inline StudioVector3 normalize(const StudioVector3& vector)
    {
        const float magnitude = length(vector);
        if (magnitude <= 0.0f) { return StudioVector3{}; }
