...
/**
 * @file CNA/Studio/Viewport/CnaPlayerHost.hpp
 * @brief Puts `cna-player` in a window, and draws the scene it loaded.
 *
 * The counterpart to `CnaStudioHost`, and built the same way and for the same reason: the
...
namespace CNA::Studio
{
    ...
    using PlayerMessageSink = std::function<void(const StudioMessage&)>;
