...
/**
 * @file CNA/Studio/Viewport/StudioAudio.hpp
 * @brief Hearing a clip without leaving the editor.
 *
 * plan.md ED-304. The abstraction exists for the same reason `StudioViewport` does: playing a
...
namespace CNA::Studio
{
     ...
     */
    class NullStudioAudio final : public StudioAudio
    {
    public:
     ...
     */
    [[nodiscard]] std::unique_ptr<StudioAudio> createCnaStudioAudio(const AssetDatabase& assets);
}
