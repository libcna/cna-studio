...
/**
 * @file CNA/Studio/Scene/SpriteAnimation.hpp
...
namespace CNA::Studio
{
    ...
    struct SpriteAnimationClip
    {
         ...
         */
        [[nodiscard]] StudioRectangle getFrameRectangle(std::size_t position) const;
    };

    /** @brief Reads the clip from @p component. */
    [[nodiscard]] SpriteAnimationClip readSpriteAnimationClip(const StudioComponent& component,
    ...
    /**
     * @brief Where a preview has got to. Studio state, never serialised.
     *
