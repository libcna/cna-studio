...
/**
 * @file CNA/Studio/Scene/EntityJson.hpp
...
namespace CNA::Studio
{
     ...
     */
    [[nodiscard]] JsonValue entityToJson(const StudioEntity& entity);
     ...
     */
    [[nodiscard]] StudioEntity entityFromJson(const JsonValue& json,
