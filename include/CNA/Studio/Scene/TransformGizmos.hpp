...
/**
 * @file CNA/Studio/Scene/TransformGizmos.hpp
...
namespace CNA::Studio
{
    ...
    struct TranslateGizmoLayout
    {
        ...
        [[nodiscard]] StudioVector2 getXTip() const
        {
            return StudioVector2{origin.x + xAxis.x * axisLength, origin.y + xAxis.y * axisLength};
        }

        /** @brief Returns the far end of the Y arm. */
        [[nodiscard]] StudioVector2 getYTip() const
        {
            return StudioVector2{origin.x + yAxis.x * axisLength, origin.y + yAxis.y * axisLength};
        }
    };
    ...
    struct RotateGizmoLayout
    {
        ...
        [[nodiscard]] StudioVector2 getPointAt(float radians) const;
    };
     ...
     */
    [[nodiscard]] StudioVector2 worldDeltaToLocal(const SceneDocument& scene,
                                                  const Uuid& entityId,
    ...
    public:
         ...
         */
        [[nodiscard]] StudioVector2 getWorldDelta(const StudioCamera2D& camera,
                                                  const StudioVector2& screenPoint,
                                                  const GizmoSnap& snap = {}) const;
    ...
    private:
        ...
        Uuid entityId_;
        StudioVector2 grabWorld_;
        StudioVector3 startLocalPosition_;

        /** @brief The world-space direction a single-axis drag is constrained to. */
        StudioVector2 constraintAxis_{1.0f, 0.0f};
    };
    ...
    public:
         ...
         * fraction of it.
         */
        [[nodiscard]] std::optional<StudioQuaternion> update(const RotateGizmoLayout& layout,
                                                             const StudioVector2& screenPoint,
                                                             const GizmoSnap& snap = {}) const;
    ...
    private:
        ...
        StudioQuaternion startWorldRotation_;
        StudioQuaternion inverseParentRotation_;
    };
    ...
    public:
         ...
         */
        [[nodiscard]] std::optional<StudioVector3> update(const ScaleGizmoLayout& layout,
                                                          const StudioVector2& screenPoint,
                                                          const GizmoSnap& snap = {}) const;
    ...
    void placeGizmoAt(Layout& layout, const StudioCamera2D& camera, const StudioVector2& pivotWorld)
    {
    ...
    public:
        ...
        [[nodiscard]] const StudioVector2& getPivot() const { return pivot_; }
    ...
    private:
        ...
        {
            Uuid entityId;
            StudioVector2 startWorldPosition;
            StudioVector3 startLocalPosition;
