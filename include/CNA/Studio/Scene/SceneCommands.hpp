...
/**
 * @file CNA/Studio/Scene/SceneCommands.hpp
 ...
 * StudioCommand.hpp for the rule and ANALYSIS.md decision D-06 for why it is absolute.
 *
...
namespace CNA::Studio
{
    ...
    class CreateEntityCommand final : public StudioCommand
    {
    public:
        /**
         ...
         */
        CreateEntityCommand(SceneDocument& document, StudioEntity entity);
     ...
     */
    class DeleteEntityCommand final : public StudioCommand
    {
    public:
     ...
     */
    class DuplicateEntityCommand final : public StudioCommand
    {
    public:
    ...
    private:
        ...
        std::vector<StudioEntity> clones_;
        bool valid_ = false;
    };

    /** @brief Renames an entity. */
    class RenameEntityCommand final : public StudioCommand
    {
    public:
     ...
     */
    class SetPropertyCommand final : public StudioCommand
    {
    public:
    ...
    {
        Uuid entityId;
        std::optional<StudioVector3> position;
        std::optional<StudioQuaternion> rotation;
        std::optional<StudioVector3> scale;
    };
     ...
     */
    class SetSceneEnvironmentCommand final : public StudioCommand
    {
    public:
    ...
    class TransformEntitiesCommand final : public StudioCommand
    {
    public:
     ...
     */
    class RelinkAssetCommand final : public StudioCommand
    {
    public:
    ...
    class AddComponentCommand final : public StudioCommand
    {
    public:
    ...
    private:
        ...
        Uuid entityId_;
        std::string componentTypeId_;
        StudioComponent prototype_;
        bool valid_ = false;
    };

    /** @brief Removes a component from an entity, preserving its property values for undo. */
    class RemoveComponentCommand final : public StudioCommand
    {
    public:
