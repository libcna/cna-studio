...
/**
 * @file CNA/Studio/Scene/PrefabDocument.hpp
 ...
 * `studioState`, because they are editor bookkeeping rather than something the game runs (D-07).
 */
...
namespace CNA::Studio
{
    ...
    /** @brief Studio-state keys that make an entity part of a prefab instance. */
    ...
    public:
         ...
         */
        void setEntities(std::vector<StudioEntity> entities) { entities_ = std::move(entities); }
