...
/**
 * @file CNA/Studio/Scene/PrefabCommands.hpp
...
namespace CNA::Studio
{
     ...
     *        (`StudioComponent::getProperty`), so comparing stored values alone would report an
     ...
     */
    class InstantiatePrefabCommand final : public StudioCommand
    {
    public:
        /**
     ...
     */
    class RevertPrefabInstanceCommand final : public StudioCommand
    {
    public:
    ...
    private:
        void replaceSubtree(const std::vector<StudioEntity>& entities);
