...
/**
 * @file CNA/Studio/Scene/Tilemap.hpp
...
namespace CNA::Studio
{
     ...
     */
    [[nodiscard]] TilemapGrid readTilemapGrid(const StudioComponent& component,
     ...
     */
    class PaintTilesCommand final : public StudioCommand
    {
    public:
