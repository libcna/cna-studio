...
/**
 * @file CNA/Studio/Scene/BuiltinComponents.hpp
...
namespace CNA::Studio
{
    ...
    namespace BuiltinComponentIds
    {
        ...
        inline constexpr const char* kSpriteAnimation = "CNA.SpriteAnimation";
    }
     ...
     * module links `cna-studio-core` and nothing else, and reaching into the project module for one
