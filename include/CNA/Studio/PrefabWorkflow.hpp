...
/**
 * @file CNA/Studio/PrefabWorkflow.hpp
 ...
 * `cna-studio-scene` and `cna-studio-assets` -- neither of which may depend on the other.
 *
...
namespace CNA::Studio
{
     ...
     */
    class CreatePrefabCommand final : public StudioCommand
    {
    public:
        /**
     ...
     * user's back.
     */
    class ApplyPrefabInstanceCommand final : public StudioCommand
    {
    public:
