...
/**
 * @file CNA/Studio/Player/PlayerHost.hpp
...
namespace CNA::Studio
{
    ...
    public:
        ...
        using Outbox = std::vector<StudioMessage>;
         ...
         */
        void handle(const StudioMessage& message, Outbox& outbox);
        ...
        [[nodiscard]] StudioMessage makeReady(const std::string& backendName) const;
         ...
         */
        [[nodiscard]] static StudioMessage makeScreenshotReply(const ScreenshotRequest& request,
    ...
    private:
        void handleLoadScene(const StudioMessage& message, Outbox& outbox);
        void handleSetProperty(const StudioMessage& message, Outbox& outbox);
        void handleReloadAsset(const StudioMessage& message, Outbox& outbox);
        void handleInput(const StudioMessage& message, Outbox& outbox);
