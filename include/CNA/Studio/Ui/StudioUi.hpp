...
/**
 * @file CNA/Studio/Ui/StudioUi.hpp
 ...
 * 2. the whole panel layer is unit-testable against NullStudioUi, with no window and no GPU;
...
namespace CNA::Studio
{
     ...
     * StudioCommand at exactly the right moment.
     */
    class StudioUi
    {
    public:
        virtual ~StudioUi() = default;
         ...
         *        StudioViewport::isRenderTextureFlippedVertically().
         */
    ...
    /**
     * @brief An StudioUi that draws nothing and interacts with nobody.
     *
     * This is not a placeholder for a missing implementation -- it is a first-class one. It makes
     * the whole panel layer testable in CI with no display, and it is what `cna-studio --headless`
