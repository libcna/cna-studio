...
/**
 * @file CNA/Studio/Ui/ImGuiStudioUi.hpp
 * @brief The Dear ImGui implementation of StudioUi.
 *
 ...
 * real editor window; both live in `cna-studio-viewport` because both need CNA.
 */
...
{
    /** @brief How ImGuiStudioUi should obtain and release clipboard text. */
     ...
     * @endcode
     */
    class ImGuiStudioUi final : public StudioUi
    {
    public:
        ImGuiStudioUi();
        ~ImGuiStudioUi() override;

        ImGuiStudioUi(const ImGuiStudioUi&) = delete;
        ImGuiStudioUi& operator=(const ImGuiStudioUi&) = delete;
