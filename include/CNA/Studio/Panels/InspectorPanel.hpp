...
/**
 * @file CNA/Studio/Panels/InspectorPanel.hpp
...
namespace CNA::Studio
{
     ...
     */
    class InspectorPanel final : public StudioPanel
    {
    public:
    ...
    private:
        ...
        void drawAddComponentControl(const StudioEntity& entity);
        ...
        struct EulerEdit
        {
            ...
            StudioVector3 degrees;
            StudioQuaternion produced;
