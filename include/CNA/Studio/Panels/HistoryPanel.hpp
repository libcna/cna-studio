...
/**
 * @file CNA/Studio/Panels/HistoryPanel.hpp
...
namespace CNA::Studio
{
     ...
     *
     * Navigation goes through StudioActions::undo/redo rather than straight into CommandHistory,
     ...
     */
    class HistoryPanel final : public StudioPanel
    {
    public:
