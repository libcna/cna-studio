...
/**
 * @file CNA/Studio/StudioContext.hpp
 * @brief The single object every panel, command and plugin is handed.
 *
 * StudioContext owns the open project, the open scene, the component registry, the asset
 ...
 * a toolkit dependency in here would undo the separation StudioUi exists to create.
 */
...
namespace CNA::Studio
{
    ...
    public:
        ...
        using CommandObserver = std::function<void(const StudioCommand&)>;
